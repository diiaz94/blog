class Admin::AdvertisingsController < ApplicationController
  ...
  def create
    ...
    respond_to do |format|
      if @advertising.save
        format.html { redirect_to root_path, notice: 'Advertising was successfully created.' }
  ...
  def update
    respond_to do |format|
      if @advertising.update(advertising_params)
        format.html { redirect_to root_path, notice: 'Advertising was successfully updated.' }
  ...
  def destroy
    @advertising.destroy
    respond_to do |format|
      format.html { redirect_to root_path, notice: 'Advertising was successfully destroyed.' }
  ...
  private
    ...
    def advertising_params
      params.require(:advertising).permit(:img_url, :link_url)
    end
end
